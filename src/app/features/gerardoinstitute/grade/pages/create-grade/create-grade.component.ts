...
import {StudentServiceGerardoInstitute} from "../../../student/service/student-api.service"
import {CourseServiceGerardoInstitute} from "../../../course/service/course-api.service"
import {GradeServiceGerardoInstitute} from "../../service/grade-api.service"
...
export class CreateGradeComponent implements OnInit {
  ...
  constructor(
    ...
    private gradeService: GradeServiceGerardoInstitute,
  ...
  onSubmit(): void {
    if (this.gradeForm.valid) {
      ...
      this.gradeService.createGrade(newGrade).subscribe({
        next: () => this.router.navigate(['/gerardoinstitute/grade/list']),
        error: (err) => {
