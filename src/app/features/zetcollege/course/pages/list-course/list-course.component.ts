...
export class ListCourseComponent implements OnInit {
  ...
  constructor(private courseService: CourseServiceZetCollege, private router: Router) {}
  ...
  editCourse(id: number): void {
    ...
    this.router.navigate(['/zetcollege/course/edit', id])
  }
  ...
  addCourse(): void {
    this.router.navigate(['/zetcollege/course/create'])
  }
