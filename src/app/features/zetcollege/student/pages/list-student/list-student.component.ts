...
export class ListStudentComponent implements OnInit {
  ...
  constructor(private studentService: StudentServiceZetCollege, private router: Router) {
  }
  ...
  editStudent(id: number): void {
    ...
    this.router.navigate(['/zetcollege/student/edit', id])
  }
  ...
  addStudent(): void {
    this.router.navigate(['/zetcollege/student/create'])
  }

  viewStudent(id: number): void {
    this.router.navigate(['/zetcollege/grade/list', id])
  }
}
